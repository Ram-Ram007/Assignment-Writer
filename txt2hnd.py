...
def text_to_handwritten(text):
    font_path = "/home/ram/Assignment/font.ttf"
    font_size = 40
    line_height = 30
        ...
        for word in words:
            ...
            if current_width + word_width > A4_WIDTH - 100:
                ...
                if position[1] > A4_HEIGHT - 100:
                    image.save(f"/home/ram/Assignment/handwritten_text_page_{current_page}.png")
                    current_page += 1
                    image = Image.new("RGB", (A4_WIDTH, A4_HEIGHT), "white")
                    draw = ImageDraw.Draw(image)
                    position = (50, 50)
    ...
    image.save(f"/home/ram/Assignment/handwritten_text_page_{current_page}.png")
    return f"/home/ram/Assignment/handwritten_text_page_{current_page}.png"
